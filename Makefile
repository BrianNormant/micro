...
GOVARS = -X github.com/briannormant/micro/internal/util.Version=$(VERSION) -X github.com/briannormant/micro/internal/util.CommitHash=$(HASH) -X 'github.com/briannormant/micro/internal/util.CompileDate=$(DATE)'
DEBUGVAR = -X github.com/briannormant/micro/v2/internal/util.Debug=ON
